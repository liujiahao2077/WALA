...
_ACTION_TOKEN_MAX = (
    153716  # here only for fast_tokenizer, see WALA/model/modules/vlm/tools/add_qwen_special_tokens/README.md
)
...
class _QWen3_VL_Interface(nn.Module):
    ...
    def build_qwenvl_inputs(self, images, instructions, solutions=None, **kwargs):
        ...
        for imgs, instruction in zip(images, instructions):
            ...
            #
            # Modified behavior:
            #   - normal image: keep feeding it into Qwen-VL as before
            #   - all-zero image: skip this image, and insert a learnable text-side
            #     missing-view special token at the same logical position
            content = []
        ...
        if solutions is not None:  #  here only for fast_tokenizer now.
            ...
            action_token_max = _ACTION_TOKEN_MAX  # here only for fast_tokenizer, see WALA/model/modules/vlm/tools/add_qwen_special_tokens/README.md
            ...
            for i in range(labels.size(0)):
                ...
                if nonzero_indices.numel() > 0:
                    ...
                    seq[:] = IGNORE_INDEX
                    RuntimeWarning(
                        "action token are on in yout tokenizer, plz see WALA/model/modules/vlm/tools/add_qwen_special_tokens/README.md."
                    )
