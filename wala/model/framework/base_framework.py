"""Base framework abstraction for WALA models."""
...
from wala.model.framework.share_tools import dict_to_namespace, read_mode_config
from wala.model.tools import FRAMEWORK_REGISTRY, FrameworkTools, auto_get_trainable_modules
