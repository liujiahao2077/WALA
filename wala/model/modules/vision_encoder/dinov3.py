...
DEFAULT_DINOV3_MODEL = "./checkpoints/dinov3/dinov3-vitb16-pretrain-lvd1689m"
...
def get_dino_model(
    backone_name: str = DEFAULT_DINOV3_MODEL,
    *,
    local_files_only: bool = True,
    token: str = None,
) -> DINOv3BackBone:
    """
    Factory for the DINOv3 encoder used by WALA.
