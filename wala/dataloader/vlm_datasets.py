...
from wala.dataloader.qwenvl_llavajson.qwen_data_config import data_list
from wala.dataloader.qwenvl_llavajson.rope2d import get_rope_index_2, get_rope_index_25
...
class LazySupervisedDataset(Dataset):
    ...
    def _get_item(self, i) -> Dict[str, torch.Tensor]:
        ...
        if isinstance(i, int):
            sources = [sources]
        assert len(sources) == 1, "Expected a single source item."
        video = None
