...
# Core registries loaded before benchmark-specific entries
from wala.dataloader.gr00t_lerobot.data_config import (
    ROBOT_TYPE_CONFIG_MAP as _BASE_CONFIG_MAP,
)
from wala.dataloader.gr00t_lerobot.embodiment_tags import (
    ROBOT_TYPE_TO_EMBODIMENT_TAG as _BASE_EMBODIMENT_MAP,
    EmbodimentTag,  # noqa: F401  – re-export for convenience
)
from wala.dataloader.gr00t_lerobot.mixtures import (
...
def _find_registry_dirs() -> list[Path]:
    ...
    # registry.py is at wala/wala/dataloader/gr00t_lerobot/registry.py
    #   parents: [0]=gr00t_lerobot, [1]=dataloader, [2]=wala(pkg), [3]=wala(repo)
